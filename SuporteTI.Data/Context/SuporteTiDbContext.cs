...
public partial class SuporteTiDbContext : DbContext
{
    ...
    public DbSet<TecnicoCategoria> TecnicoCategorias { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Configuração da chave primária composta para a entidade de junção TecnicoCategoria
        modelBuilder.Entity<TecnicoCategoria>().HasKey(tc => new { tc.IdTecnico, tc.IdCategoria });
